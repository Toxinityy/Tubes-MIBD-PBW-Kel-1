...
(5, 'So Good, Well Design.', 2, 2),
(2, "I don't really liked it, maybe need an improvement in design.", 2, 3),
(1, "Not RECCOMENDED.", 2, 4),
(4, "Personally, i like the size but the design very bad", 2, 5),
(3, "Package not being delivered", 2, 6),
(5, "Very Good.", 2, 7),
(5, "Good game", 2, 8),
(3, "I don't really liked it, maybe need an improvement in design.", 2, 9),
(5, "Lorem ipsum dolor sit amet", 2, 10),
(3, "Lorem ipsum dolor sit amet", 2, 11),
(5, "Lorem ipsum dolor sit amet", 2, 12),
(5, "Lorem ipsum dolor sit amet", 2, 13),
(5, "Lorem ipsum dolor sit amet", 2, 14),
(5, "Lorem ipsum dolor sit amet", 2, 15),
(5, "Lorem ipsum dolor sit amet", 2, 16),
(5, "Lorem ipsum dolor sit amet", 2, 17),
(5, "Lorem ipsum dolor sit amet", 2, 18),
(5, "Lorem ipsum dolor sit amet", 2, 19),
(5, "Lorem ipsum dolor sit amet", 2, 20),

(4, 'Spacious laptop backpack, comfortable to wear.', 3, 1),
(5, 'So Good, Well Design.', 3, 2),
(2, "I don't really liked it, maybe need an improvement in design.", 3, 3),
(1, "Not RECCOMENDED.", 3, 4),
(4, "Personally, i like the size but the design very bad", 3, 5),
(3, "Package not being delivered", 3 ,6),
(5, "Very Good.", 3, 7),
(5, "Good game", 3, 8),
(3, "I don't really liked it, maybe need an improvement in design.", 3, 9),
(5, "Lorem ipsum dolor sit amet", 3, 10),
(3, "Lorem ipsum dolor sit amet", 3, 11),
(2, "Lorem ipsum dolor sit amet", 3, 12),
(2, "Lorem ipsum dolor sit amet", 3, 13),
(3, "Lorem ipsum dolor sit amet", 3, 14),
(3, "Lorem ipsum dolor sit amet", 3, 15),
(5, "Lorem ipsum dolor sit amet", 3, 16),
(5, "Lorem ipsum dolor sit amet", 3, 17),
(5, "Lorem ipsum dolor sit amet", 3, 18),
(5, "Lorem ipsum dolor sit amet", 3, 19),
(5, "Lorem ipsum dolor sit amet", 3, 20),

(5, 'Beautiful tote bag, perfect for travel.', 4);
